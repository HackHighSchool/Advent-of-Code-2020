...
for line in fileArr:
    slope.append(line[0:len(line)-1] * (len(line) * (math.ceil(line_count / len(line)) * 3))) #Need to traverse right three for every traversal down 1 => rows must be 3x as long as cols
